...
Mods.prototype.pre_initialize = function pre_initialize() {
  ...
  this.mods.push(require('./mods/pwa-chat-app/index')(this.app));
  ...
  for (var i = 0; i < this.mods.length; i++) {
    var mi = 0;
    for (var j = 0; j < this.app.options.modules.length; j++) { if (this.mods[i].name == this.app.options.modules[j]) { mi = 1; }}
